...
export default function Samples() {
  ...
  const visible = all.filter((s) =>
    ...
    (!flt.category ||
      s.category?.toLowerCase().includes(flt.category.toLowerCase())) &&
    (!flt.subCategory ||
      s.subCategory?.toLowerCase().includes(flt.subCategory.toLowerCase())) &&
    (!flt.brand ||
      s.brandName?.toLowerCase().includes(flt.brand.toLowerCase())) &&
        ...
        <div className="border rounded p-4 mb-4 grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-50">
          ...
          <div>
            ...
            <input
              ...
              value={flt.dateFrom}
              onChange={(e) =>
                setFlt((f) => ({ ...f, dateFrom: e.target.value }))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              value={flt.dateTo}
              onChange={(e) =>
                setFlt((f) => ({ ...f, dateTo: e.target.value }))
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              value={flt.category}
              onChange={(e) =>
                setFlt((f) => ({ ...f, category: e.target.value }))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFlt((f) => ({ ...f, subCategory: e.target.value }))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              value={flt.brand}
              onChange={(e) =>
                setFlt((f) => ({ ...f, brand: e.target.value }))
              }
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFlt((f) => ({ ...f, returnable: e.target.value }))
              }
            >
