...
const DEFAULT_TERMS = `1. The Vendor warrants that all goods supplied shall strictly conform to the specifications, samples (pre-approved or otherwise), drawings, and/or standards explicitly referenced in this Purchase Order.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Enter terms as numbered list:
1. First term...
2. Second term...
3. Third term..."
              />
