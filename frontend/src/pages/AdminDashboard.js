...
const adminPages = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Common Configuration", path: "/admin-dashboard/hrms/configuration", permission: "hrms-employees" },
      { name: "Salary", path: "/admin-dashboard/hrms/salary", permission: "hrms-employees" },
