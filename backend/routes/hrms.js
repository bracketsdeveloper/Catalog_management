 ...
 */
router.get("/hrms/salary/config/:employeeId", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.post("/hrms/salary/config", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.get("/hrms/salary/configs", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.post("/hrms/salary/calculate/:employeeId", authenticate, requireAdmin, async (req, res) => {
  try {
    const { employeeId } = req.params;
 ...
 */
router.post("/hrms/salary/calculate-all", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.get("/hrms/salary/records", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.get("/hrms/salary/record/:employeeId/:month/:year", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.put("/hrms/salary/record/:id", authenticate, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/hrms/salary/record/:id/adjustment", authenticate, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post("/hrms/salary/record/:id/approve", authenticate, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * Mark as paid
 */
router.post("/hrms/salary/record/:id/mark-paid", authenticate, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.get("/hrms/salary/export", authenticate, requireAdmin, async (req, res) => {
  try {
 ...
 */
router.post("/hrms/salary/preview/:employeeId", authenticate, requireAdmin, async (req, res) => {
  try {
    const { employeeId } = req.params;
